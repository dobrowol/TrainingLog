...
public class StackedBarActivity extends BaseChart implements OnSeekBarChangeListener, OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart.setLayoutDirection(BarChart.LAYOUT_DIRECTION_LTR);
