...
public class ChartActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trainingGoalJoinViewModel.getAllGroupedByGoal().observe(this, trainingGoalJoins -> {
            if(trainingGoalJoins != null){
                setData(trainingGoalJoins);
            }
        });
...
//        setData(45, 180);
    ...
    private void setData(List<TrainingGoalJoin> trainingGoalJoins) {
        String goal = trainingGoalJoins.get(0).goal;
        ...
        for(TrainingGoalJoin trainingGoalJoin : trainingGoalJoins){
            ...
            if(!goal.equals( trainingGoalJoin.goal)){

                set1 = new LineDataSet(values, goal);
                ...
                goal = trainingGoalJoin.goal;
                values = new ArrayList<>();
                i =0;
            }
            values.add(new Entry(i++, trainingGoalJoin.load));
            if(max < trainingGoalJoin.load)
                max = trainingGoalJoin.load;
        }
        set1 = new LineDataSet(values, goal);
